  ...
  taskArray.forEach((task) => {
    ...
    if (
      ...
      const html =
        ...
        `<p style="font-weight: bold; margin-top: 10px; font-size: 30px; text-align: center">This website is blocked! Time is lickin\' by! Get back to work (${
          task.name
        }) until ${new Date(task.endTime).toLocaleTimeString([], {
          hour: "numeric",
          minute: "2-digit",
        })} ;)</p>` +
        "</div>";
